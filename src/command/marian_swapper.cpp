  ...
  while (std::getline(std::cin, line)) {
    ...
    for(auto history : histories) {
      ...
      if (alignments) {
        ...
        // The below is just there to show how access them programmatically.
        // Note: you can convert to hard with data::ConvertSoftAlignToHardAlign(alignment, threshold)
