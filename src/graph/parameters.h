...
public:
  ...
  // Free the underlying memory but leave the parameters and names with dangling pointers.
  // Only use this if you're going to edit the memory pointers manually.
